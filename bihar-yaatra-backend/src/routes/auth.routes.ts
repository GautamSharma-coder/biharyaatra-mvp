...
import { register, login, refresh, logout, getMe, updateMe, getAllUsers, adminCreateUser, updateUserRole, adminDeleteUser, getAdminStats } from '../controllers/auth.controller';
