...
import { register, login, refresh, logout, getMe, updateMe, getAllUsers, adminCreateUser, updateUserRole, adminDeleteUser, getAdminStats, sendOtp, verifyOtp } from '../controllers/auth.controller';
