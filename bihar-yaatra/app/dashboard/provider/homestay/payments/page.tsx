    ...
    return (
        <div className="animate-fade-in space-y-6">
            <header className="mb-8">
                <h1 className="text-3xl font-display font-black text-gray-900 tracking-tight capitalize">Payments</h1>
                <p className="text-gray-500 mt-2 font-medium">Manage your payments information and settings here.</p>
            </header>
